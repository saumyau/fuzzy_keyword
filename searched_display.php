...
<?php
   ...
   echo "<tr>";
   echo "<td>"."Hi ".$x." !"."</td>";
   echo "<td>"."<input style='margin-left: 500px' type='text' name='search' placeholder='Search'>"."</td>";
   echo "<td><input type='submit' name='Search Keyword'></td>";
   echo "</tr>";
   echo "</table>";
   echo "</form>";
//print_r($files1);
  ...
  $var=1;
    while (($file = readdir($dh)) !== false){ 
      if(strcmp($file,'.')&&strcmp($file,'..'))
      {
        ...
        echo "<td>".$var."</td>";
        echo "<td>".$file."</td>"; 
        echo "<td><a href=''/'.$dir.'/'.$file' download='$file'>"."Click me!"."</a></td>";
        echo "</tr>";
         $var++;
      }
    }
